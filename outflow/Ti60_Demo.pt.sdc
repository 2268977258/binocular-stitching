...
create_clock -period 20.8333 clk_code
...
#########################
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_ctl1}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_ctl1}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~277}] -max 0.414 [get_ports {cmos2_data[0]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~277}] -min 0.276 [get_ports {cmos2_data[0]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~278}] -max 0.414 [get_ports {cmos2_data[1]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~278}] -min 0.276 [get_ports {cmos2_data[1]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~266}] -max 0.414 [get_ports {cmos2_data[2]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~266}] -min 0.276 [get_ports {cmos2_data[2]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~267}] -max 0.414 [get_ports {cmos2_data[3]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~267}] -min 0.276 [get_ports {cmos2_data[3]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~255}] -max 0.414 [get_ports {cmos2_data[4]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~255}] -min 0.276 [get_ports {cmos2_data[4]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~256}] -max 0.414 [get_ports {cmos2_data[5]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~256}] -min 0.276 [get_ports {cmos2_data[5]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~243}] -max 0.414 [get_ports {cmos2_data[6]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~243}] -min 0.276 [get_ports {cmos2_data[6]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~244}] -max 0.414 [get_ports {cmos2_data[7]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~244}] -min 0.276 [get_ports {cmos2_data[7]}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~128}] -max 0.414 [get_ports {cmos2_href}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~128}] -min 0.276 [get_ports {cmos2_href}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_pclk}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_pclk}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~129}] -max 0.414 [get_ports {cmos2_vsync}]
set_input_delay -clock_fall -clock cmos2_pclk -reference_pin [get_ports {cmos2_pclk~CLKOUT~1~129}] -min 0.276 [get_ports {cmos2_vsync}]
...
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~221}] -max 0.414 [get_ports {cmos_data[0]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~221}] -min 0.276 [get_ports {cmos_data[0]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~222}] -max 0.414 [get_ports {cmos_data[1]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~222}] -min 0.276 [get_ports {cmos_data[1]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~204}] -max 0.414 [get_ports {cmos_data[2]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~204}] -min 0.276 [get_ports {cmos_data[2]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~205}] -max 0.414 [get_ports {cmos_data[3]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~205}] -min 0.276 [get_ports {cmos_data[3]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~71}] -max 0.414 [get_ports {cmos_data[4]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~71}] -min 0.276 [get_ports {cmos_data[4]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~72}] -max 0.414 [get_ports {cmos_data[5]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~72}] -min 0.276 [get_ports {cmos_data[5]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~95}] -max 0.414 [get_ports {cmos_data[6]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~95}] -min 0.276 [get_ports {cmos_data[6]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~96}] -max 0.414 [get_ports {cmos_data[7]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~96}] -min 0.276 [get_ports {cmos_data[7]}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~112}] -max 0.414 [get_ports {cmos_href}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~112}] -min 0.276 [get_ports {cmos_href}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos_pclk}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos_pclk}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~113}] -max 0.414 [get_ports {cmos_vsync}]
set_input_delay -clock_fall -clock cmos_pclk -reference_pin [get_ports {cmos_pclk~CLKOUT~1~113}] -min 0.276 [get_ports {cmos_vsync}]
...
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_ctl2}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_ctl2}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_ctl3}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_ctl3}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_sclk}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_sclk}]
...
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_sdat_IN}]
# set_input_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_sdat_IN}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_sdat_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_sdat_OUT}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -max <MAX CALCULATION> [get_ports {cmos2_sdat_OE}]
# set_output_delay -clock <CLOCK> [-reference_pin <clkout_pad>] -min <MIN CALCULATION> [get_ports {cmos2_sdat_OE}]
...
# set_clock_latency -source -setup <board_max + 0.026> [get_ports {clk_code}]
# set_clock_latency -source -hold <board_min + 0.054> [get_ports {clk_code}]
