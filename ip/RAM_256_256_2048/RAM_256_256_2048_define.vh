...
localparam GROUP_DATA_WIDTH_B = 256;
...
localparam GROUP_DATA_WIDTH = 256;
localparam BYTEEN_WIDTH = 1;
localparam WIDTH_RATIO = 4;
localparam GROUP_DATA_WIDTH_A = 256;
localparam DATA_WIDTH_A = 256;
localparam DATA_WIDTH_B = 256;
